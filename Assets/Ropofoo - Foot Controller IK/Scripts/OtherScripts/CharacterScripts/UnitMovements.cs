...
namespace ASD
{
    ...
    public class UnitMovements : MonoBehaviour
    {
        ...
        {
            m_Camera.OutsideUpdate(Time.deltaTime);
        }
        ...
        private void UnitTurn()
        {
            if (isMoving && OnGround)
                m_RB.rotation = Quaternion.Lerp(m_RB.rotation, Quaternion.LookRotation(m_MoveDirection), m_TurnSpeed * Time.fixedDeltaTime);
        }
